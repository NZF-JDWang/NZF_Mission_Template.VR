...
_civFactions = ["CFP_C_AFG"]; //Array of factions whose vests are safe for undercover units to wear
...
_civilianVests = ["CUP_V_OI_TKI_Jacket6_04","CUP_V_OI_TKI_Jacket6_05","CUP_V_OI_TKI_Jacket6_06","CUP_V_OI_TKI_Jacket5_04","CUP_V_OI_TKI_Jacket5_05","CUP_V_OI_TKI_Jacket5_06"];
...
_civilianUniforms = ["CFP_U_KhetPartug_Long_Black","CFP_U_KhetPartug_Long_Blue","CFP_U_KhetPartug_Long_BlueGrey","CFP_U_KhetPartug_Long_Brown","CFP_U_KhetPartug_Long_Creme","CUP_O_TKI_Khet_Partug_01","CFP_U_KhetPartug_Long_Grey","CFP_U_KhetPartug_Short_Black","CFP_U_KhetPartug_Short_Blue","CFP_U_KhetPartug_Short_BlueGrey","CFP_U_KhetPartug_Short_Brown","CUP_O_TKI_Khet_Partug_05","CFP_U_KhetPartug_Short_Creme"];
...
_civilianHeadgear = ["CUP_H_TKI_Pakol_1_01","CUP_H_TKI_Pakol_2_04","CUP_H_TKI_Pakol_2_05","CUP_H_TKI_Pakol_2_06","CUP_H_TKI_Pakol_1_02","CUP_H_TKI_Pakol_1_03","CUP_H_TKI_Pakol_1_04","CUP_H_TKI_SkullCap_01","CUP_H_TKI_SkullCap_02","CUP_H_TKI_SkullCap_03","CUP_H_TKI_SkullCap_04","CUP_H_TKI_SkullCap_05","CUP_H_TKI_SkullCap_06","CUP_H_TKI_Lungee_Open_06","CUP_H_TKI_Lungee_Open_05","CUP_H_TKI_Lungee_Open_04","CUP_H_TKI_Lungee_Open_03","CUP_H_TKI_Lungee_Open_02","CUP_H_TKI_Lungee_Open_01"];
...
_civilianBackpacks = ["B_Messenger_Gray_F","B_Messenger_Coyote_F","B_CivilianBackpack_01_Everyday_Black_F",	"B_FieldPack_cbr"];

//(Array of classnames) Safe vehicles to drive in (automatically includes vehicles from the civilian factions above).
_civilianVehicleArray = ["CUP_C_Volha_Gray_TKCIV", "CUP_C_Volha_Blue_TKCIV", "CUP_C_Lada_GreenTK_CIV", "CUP_C_Skoda_Blue_CIV"];
...
_incogFactions = ["CFP_O_TBAN"]; //Array of enemy factions whose items and vehicles will allow the player to impersonate the enemy
